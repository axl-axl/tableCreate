<template>
  <div id="radioEditorBox" v-if="content.type==='radio'">
    <label>问题:</label>
    <div class="question">
    ...
    <div class="row" v-for='(item,key) in content.items' :key="key">
        ...
        <input type="number" v-model='item.relationQuestion' placeholder="关联题号" min='1' @blur="_addQuestionRelative(item.relationQuestion)" v-if="!item.relationQuestion">
